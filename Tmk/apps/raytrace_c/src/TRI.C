...
FILE	*pf;
	...
	pt    = GlobalMallocSec(sizeof(TRI )*po->numelements,  "tri.c");
	vlist = GlobalMallocSec(sizeof(VEC3)*(totalverts + 1), "tri.c");
	nlist = GlobalMallocSec(sizeof(VEC3)*totalverts,	    "tri.c");
